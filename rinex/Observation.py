...
def parseHeader(obs, line):
    ...
    if endOfHeaderRGX.search(line): 
        ...
        #print("Numberof Obs:",obs['numObsType'])
...
def parseObsData(obs,line):
    ...
    if epochRGX.search(line):
        ...
        mm = int(line[13:15])
        ss = int(line[16:18])
        # quick dodgy fix to fix ms error, it is not correct:
        ...
        #print("LINE:",line)
        #print("TIME",YY,MM,DD,hh,mm,ss,ms)#flag,"NumSats",numSats)
